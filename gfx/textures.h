...
typedef struct jta_texture_T jta_texture;

struct jta_texture_create_info_T
{
    VkFormat format;
    VkSampleCountFlagBits samples;
    VkImageTiling tiling;
};
typedef struct jta_texture_create_info_T jta_texture_create_info;
